...
// This file was generated on 2018-10-25 11:51:08.150059 -0500 CDT m=&#43;10.825028936
...
func init() {
	...
	isValidRoute = regexp.MustCompile("(^\\/person\\/(\\w+)?$|^\\/signal\\/issues-completed\\/team\\/(\\w+)?$|^\\/signal\\/on-time-delivery\\/team\\/(\\w+)?$|^\\/signal\\/rework-rate\\/team\\/(\\w+)?$|^\\/data\\/sprints$|^\\/admin\\/people$|^$|^\\/welcome$|^\\/issue\\/(\\w+)?$|^\\/data\\/projects$|^\\/admin$|^\\/commit\\/(\\w+)?$|^\\/language\\/(\\w+)?$|^\\/repository\\/(\\w+)?$|^\\/signal\\/commits\\/person\\/(\\w+)?$|^\\/signal\\/defects-rate\\/team\\/(\\w+)?$|^\\/signal\\/delivered-vs-committed\\/team\\/(\\w+)?$|^\\/data\\/issues$|^\\/signal\\/defects-density\\/team\\/(\\w+)?$|^\\/signal\\/sprint-volatility\\/team\\/(\\w+)?$|^\\/data\\/people$|^\\/cost-center\\/(\\w+)?$|^\\/project\\/(\\w+)?$|^\\/signal\\/cycle-time\\/team\\/(\\w+)?$|^\\/data\\/locations$|^\\/error$|^\\/file\\/(\\w+)?$|^\\/issues\\/performance$|^\\/issues\\/workflow\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/throughput\\/team\\/(\\w+)?$|^\\/data\\/teams$|^\\/locations\\/performance$|^\\/signal\\/changes-per-commit\\/person\\/(\\w+)?$|^\\/signal\\/sprint-health\\/team\\/(\\w+)?$|^\\/admin\\/cost-center$|^\\/admin\\/roles$|^\\/$|^\\/signal\\/cycle-time\\/person\\/(\\w+)?$|^\\/signal\\/backlog-change\\/team\\/(\\w+)?$|^\\/teams\\/performance$|^\\/location\\/(\\w+)?$|^\\/people\\/performance$|^\\/signal\\/issues-worked\\/person\\/(\\w+)?$|^\\/admin\\/mapping$|^\\/signal\\/code-ownership\\/person\\/(\\w+)?$|^\\/signal\\/rework-rate\\/person\\/(\\w+)?$|^\\/signal\\/traceability\\/person\\/(\\w+)?$|^\\/signal\\/initiative-issues\\/team\\/(\\w+)?$|^\\/signal\\/scheduled-rate\\/team\\/(\\w+)?$|^\\/signal\\/cost\\/team\\/(\\w+)?$|^\\/data\\/commits$|^\\/signal\\/innovation-rate\\/team\\/(\\w+)?$|^\\/data\\/repositories$|^\\/sprint\\/(\\w+)?$|^\\/team\\/(\\w+)?$)")
	routes = []*Route{
		&Route{
			Name:           "Person",
			Path:	        "/person/:id",
