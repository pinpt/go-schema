...
// This file was generated on 2018-09-26 19:06:12.88903397 &#43;0200 CEST m=&#43;11.216771197
...
func init() {
	isPublicRoute = regexp.MustCompile("(^\\/error$|^\\/admin\\/activate$|^\\/welcome$)")
	isValidRoute = regexp.MustCompile("(^\\/performance\\/people\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/person\\/rework-rate\\/(\\w+)?$|^\\/signal\\/person\\/traceability\\/(\\w+)?$|^\\/signal\\/team\\/issues-closed\\/(\\w+)?$|^\\/performance\\/team\\/(\\w+)?$|^\\/signal\\/team\\/sprint-volatility\\/(\\w+)?$|^\\/signal\\/person\\/commits\\/(\\w+)?$|^\\/signal\\/person\\/changes-per-commit\\/(\\w+)?$|^\\/signal\\/team\\/backlog-change\\/(\\w+)?$|^\\/signal\\/team\\/cycle-time\\/data\\/(\\w+)?$|^\\/signal\\/team\\/defects-rate\\/(\\w+)?$|^\\/data\\/person\\/commits$|^\\/data\\/team\\/issues-open$|^\\/admin\\/roles$|^\\/languages$|^$|^\\/signal\\/team\\/rework-rate\\/(\\w+)?$|^\\/work-forecast\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/data\\/team\\/cost$|^\\/admin$|^\\/performance\\/location$|^\\/jira\\/(\\w+)?$|^\\/signal\\/team\\/cost\\/(\\w+)?$|^\\/data\\/person\\/traceability$|^\\/error$|^\\/signal\\/team\\/defects-density\\/(\\w+)?$|^\\/data\\/person\\/rework-rate$|^\\/admin\\/activate$|^\\/admin\\/cost-center$|^\\/$|^\\/performance-detail\\/people\\/(\\w+)?$|^\\/signal\\/team\\/delivered-vs-committed\\/(\\w+)?$|^\\/performance-detail\\/team\\/(\\w+)?$|^\\/data\\/team\\/issues-completed$|^\\/admin\\/mapping$|^\\/signal\\/person\\/issues-worked\\/(\\w+)?$|^\\/signal\\/person\\/code-ownership\\/(\\w+)?$|^\\/signal\\/person\\/cycle-time\\/(\\w+)?$|^\\/signal\\/team\\/cycle-time\\/(\\w+)?$|^\\/signal\\/team\\/innovation-rate\\/(\\w+)?$|^\\/signal\\/team\\/scheduled-rate\\/(\\w+)?$|^\\/signal\\/team\\/initiative-issues\\/(\\w+)?$|^\\/data\\/person\\/issues-worked$|^\\/welcome$|^\\/admin\\/people$|^\\/data\\/team\\/sprints-completed$)")
	routes = []*Route{
		&Route{
