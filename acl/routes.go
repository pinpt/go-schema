...
// This file was generated on 2018-10-30 00:57:43.844440605 &#43;0100 CET m=&#43;10.041271260
...
func init() {
	...
	isValidRoute = regexp.MustCompile("(^\\/welcome$|^\\/signal\\/changes-per-commit\\/person\\/(\\w+)?$|^\\/signal\\/on-time-delivery\\/team\\/(\\w+)?$|^\\/$|^\\/signal\\/sprint-volatility\\/team\\/(\\w+)?$|^\\/data\\/commits$|^\\/admin\\/people$|^\\/teams\\/performance$|^\\/data\\/sprints$|^\\/issue\\/(\\w+)?$|^\\/language\\/(\\w+)?$|^\\/issues\\/performance$|^\\/issues\\/workflow\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/defects-density\\/team\\/(\\w+)?$|^\\/file\\/(\\w+)?$|^\\/location\\/(\\w+)?$|^\\/data\\/people$|^\\/admin\\/cost-center$|^\\/admin\\/roles$|^\\/project\\/(\\w+)?$|^\\/people\\/performance$|^\\/signal\\/delivered-vs-committed\\/team\\/(\\w+)?$|^\\/signal\\/scheduled-rate\\/team\\/(\\w+)?$|^\\/data\\/teams$|^\\/signal\\/cycle-time\\/team\\/(\\w+)?$|^\\/admin$|^\\/signal\\/traceability\\/person\\/(\\w+)?$|^\\/signal\\/issues-completed\\/team\\/(\\w+)?$|^\\/locations\\/performance$|^\\/signal\\/cost\\/team\\/(\\w+)?$|^\\/signal\\/rework-rate\\/team\\/(\\w+)?$|^\\/cost-center\\/(\\w+)?$|^\\/signal\\/backlog-change\\/team\\/(\\w+)?$|^\\/signal\\/defects-rate\\/team\\/(\\w+)?$|^$|^\\/signal\\/issues-worked\\/person\\/(\\w+)?$|^\\/sprint\\/(\\w+)?$|^\\/signal\\/code-ownership\\/person\\/(\\w+)?$|^\\/signal\\/commits\\/person\\/(\\w+)?$|^\\/signal\\/cycle-time\\/person\\/(\\w+)?$|^\\/person\\/(\\w+)?$|^\\/team\\/(\\w+)?$|^\\/data\\/locations$|^\\/signal\\/rework-rate\\/person\\/(\\w+)?$|^\\/data\\/repositories$|^\\/commit\\/(\\w+)?$|^\\/repository\\/(\\w+)?$|^\\/data\\/issues$|^\\/signal\\/throughput\\/team\\/(\\w+)?$|^\\/data\\/projects$|^\\/admin\\/mapping$|^\\/error$|^\\/signal\\/innovation-rate\\/team\\/(\\w+)?$|^\\/signal\\/sprint-health\\/team\\/(\\w+)?$|^\\/signal\\/initiative-issues\\/team\\/(\\w+)?$)")
	routes = []*Route{
		&Route{
			Name:           "Welcome",
			Path:	        "/welcome",
