...
// This file was generated on 2018-10-11 22:19:07.446948 -0500 CDT m=&#43;0.005920785
...
func init() {
	...
	isValidRoute = regexp.MustCompile("(^\\/signal\\/commits\\/person\\/(\\w+)?$|^\\/signal\\/issues-worked\\/person\\/(\\w+)?$|^\\/teams\\/performance$|^\\/signal\\/rework-rate\\/team\\/(\\w+)?$|^\\/people\\/performance$|^\\/data\\/people$|^\\/data\\/sprints$|^\\/signal\\/code-ownership\\/person\\/(\\w+)?$|^\\/data\\/commits$|^\\/issues\\/performance$|^\\/welcome$|^\\/issue\\/(\\w+)?$|^\\/signal\\/traceability\\/person\\/(\\w+)?$|^\\/signal\\/scheduled-rate\\/team\\/(\\w+)?$|^\\/signal\\/sprint-volatility\\/team\\/(\\w+)?$|^\\/team\\/(\\w+)?$|^\\/locations\\/performance$|^$|^\\/cost-center\\/(\\w+)?$|^\\/issues\\/workflow\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/cost\\/team\\/(\\w+)?$|^\\/signal\\/throughput\\/team\\/(\\w+)?$|^\\/admin$|^\\/admin\\/cost-center$|^\\/language\\/(\\w+)?$|^\\/signal\\/on-time-delivery\\/team\\/(\\w+)?$|^\\/data\\/repositories$|^\\/admin\\/people$|^\\/$|^\\/signal\\/sprint-health\\/team\\/(\\w+)?$|^\\/signal\\/initiative-issues\\/team\\/(\\w+)?$|^\\/data\\/locations$|^\\/data\\/projects$|^\\/data\\/teams$|^\\/admin\\/mapping$|^\\/admin\\/roles$|^\\/commit\\/(\\w+)?$|^\\/person\\/(\\w+)?$|^\\/signal\\/cycle-time\\/person\\/(\\w+)?$|^\\/signal\\/cycle-time\\/team\\/(\\w+)?$|^\\/project\\/(\\w+)?$|^\\/sprint\\/(\\w+)?$|^\\/signal\\/backlog-change\\/team\\/(\\w+)?$|^\\/signal\\/defects-density\\/team\\/(\\w+)?$|^\\/signal\\/changes-per-commit\\/person\\/(\\w+)?$|^\\/signal\\/delivered-vs-committed\\/team\\/(\\w+)?$|^\\/error$|^\\/repository\\/(\\w+)?$|^\\/signal\\/innovation-rate\\/team\\/(\\w+)?$|^\\/data\\/issues$|^\\/file\\/(\\w+)?$|^\\/signal\\/rework-rate\\/person\\/(\\w+)?$|^\\/signal\\/defects-rate\\/team\\/(\\w+)?$|^\\/signal\\/issues-completed\\/team\\/(\\w+)?$|^\\/location\\/(\\w+)?$)")
	routes = []*Route{
		&Route{
			Name:           "PersonCommits",
