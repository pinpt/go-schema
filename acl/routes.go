...
// This file was generated on 2018-10-25 16:45:54.238109 -0500 CDT m=&#43;9.215761889
...
func init() {
	...
	isValidRoute = regexp.MustCompile("(^$|^\\/project\\/(\\w+)?$|^\\/signal\\/defects-rate\\/team\\/(\\w+)?$|^\\/data\\/projects$|^\\/signal\\/initiative-issues\\/team\\/(\\w+)?$|^\\/admin\\/cost-center$|^\\/error$|^\\/cost-center\\/(\\w+)?$|^\\/issue\\/(\\w+)?$|^\\/data\\/sprints$|^\\/language\\/(\\w+)?$|^\\/signal\\/changes-per-commit\\/person\\/(\\w+)?$|^\\/signal\\/rework-rate\\/team\\/(\\w+)?$|^\\/signal\\/issues-worked\\/person\\/(\\w+)?$|^\\/teams\\/performance$|^\\/admin\\/roles$|^\\/signal\\/sprint-health\\/team\\/(\\w+)?$|^\\/welcome$|^\\/location\\/(\\w+)?$|^\\/team\\/(\\w+)?$|^\\/signal\\/backlog-change\\/team\\/(\\w+)?$|^\\/data\\/teams$|^\\/person\\/(\\w+)?$|^\\/issues\\/workflow\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/traceability\\/person\\/(\\w+)?$|^\\/people\\/performance$|^\\/signal\\/delivered-vs-committed\\/team\\/(\\w+)?$|^\\/signal\\/throughput\\/team\\/(\\w+)?$|^\\/$|^\\/sprint\\/(\\w+)?$|^\\/data\\/people$|^\\/data\\/commits$|^\\/commit\\/(\\w+)?$|^\\/signal\\/sprint-volatility\\/team\\/(\\w+)?$|^\\/locations\\/performance$|^\\/signal\\/cost\\/team\\/(\\w+)?$|^\\/signal\\/innovation-rate\\/team\\/(\\w+)?$|^\\/admin$|^\\/admin\\/people$|^\\/signal\\/code-ownership\\/person\\/(\\w+)?$|^\\/signal\\/cycle-time\\/team\\/(\\w+)?$|^\\/signal\\/issues-completed\\/team\\/(\\w+)?$|^\\/admin\\/mapping$|^\\/signal\\/defects-density\\/team\\/(\\w+)?$|^\\/signal\\/scheduled-rate\\/team\\/(\\w+)?$|^\\/data\\/issues$|^\\/data\\/locations$|^\\/repository\\/(\\w+)?$|^\\/issues\\/performance$|^\\/signal\\/rework-rate\\/person\\/(\\w+)?$|^\\/file\\/(\\w+)?$|^\\/data\\/repositories$|^\\/signal\\/on-time-delivery\\/team\\/(\\w+)?$|^\\/signal\\/commits\\/person\\/(\\w+)?$|^\\/signal\\/cycle-time\\/person\\/(\\w+)?$)")
	routes = []*Route{
		&Route{
