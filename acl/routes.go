...
// This file was generated on 2018-10-24 15:26:58.936072 -0500 CDT m=&#43;8.469679159
...
func init() {
	...
	isValidRoute = regexp.MustCompile("(^\\/person\\/(\\w+)?$|^\\/issues\\/performance$|^\\/signal\\/rework-rate\\/person\\/(\\w+)?$|^\\/$|^\\/admin\\/mapping$|^\\/signal\\/sprint-volatility\\/team\\/(\\w+)?$|^\\/data\\/projects$|^\\/language\\/(\\w+)?$|^\\/data\\/commits$|^$|^\\/signal\\/defects-density\\/team\\/(\\w+)?$|^\\/project\\/(\\w+)?$|^\\/admin\\/cost-center$|^\\/signal\\/innovation-rate\\/team\\/(\\w+)?$|^\\/signal\\/sprint-health\\/team\\/(\\w+)?$|^\\/signal\\/cycle-time\\/team\\/(\\w+)?$|^\\/repository\\/(\\w+)?$|^\\/signal\\/initiative-issues\\/team\\/(\\w+)?$|^\\/data\\/people$|^\\/error$|^\\/signal\\/code-ownership\\/person\\/(\\w+)?$|^\\/location\\/(\\w+)?$|^\\/issues\\/workflow\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/cycle-time\\/person\\/(\\w+)?$|^\\/signal\\/backlog-change\\/team\\/(\\w+)?$|^\\/data\\/locations$|^\\/admin$|^\\/signal\\/scheduled-rate\\/team\\/(\\w+)?$|^\\/signal\\/issues-worked\\/person\\/(\\w+)?$|^\\/signal\\/delivered-vs-committed\\/team\\/(\\w+)?$|^\\/data\\/teams$|^\\/admin\\/roles$|^\\/people\\/performance$|^\\/locations\\/performance$|^\\/signal\\/changes-per-commit\\/person\\/(\\w+)?$|^\\/signal\\/traceability\\/person\\/(\\w+)?$|^\\/signal\\/cost\\/team\\/(\\w+)?$|^\\/signal\\/on-time-delivery\\/team\\/(\\w+)?$|^\\/teams\\/performance$|^\\/signal\\/throughput\\/team\\/(\\w+)?$|^\\/commit\\/(\\w+)?$|^\\/admin\\/people$|^\\/issue\\/(\\w+)?$|^\\/signal\\/defects-rate\\/team\\/(\\w+)?$|^\\/file\\/(\\w+)?$|^\\/signal\\/issues-completed\\/team\\/(\\w+)?$|^\\/signal\\/rework-rate\\/team\\/(\\w+)?$|^\\/data\\/issues$|^\\/data\\/repositories$|^\\/data\\/sprints$|^\\/team\\/(\\w+)?$|^\\/sprint\\/(\\w+)?$|^\\/cost-center\\/(\\w+)?$|^\\/signal\\/commits\\/person\\/(\\w+)?$|^\\/welcome$)")
	routes = []*Route{
		&Route{
			Name:           "Person",
			Path:	        "/person/:id",
