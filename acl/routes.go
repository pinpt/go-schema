...
// This file was generated on 2018-10-03 09:39:46.603994756 -0500 CDT m=&#43;10.206794955
...
func init() {
	isPublicRoute = regexp.MustCompile("(^\\/admin\\/activate$|^\\/welcome$|^\\/error$)")
	isValidRoute = regexp.MustCompile("(^\\/admin\\/activate$|^\\/admin\\/roles$|^\\/signal\\/team\\/cost\\/(\\w+)?$|^\\/signal\\/team\\/initiative-issues\\/(\\w+)?$|^\\/data\\/person\\/commits\\/(\\w+)?$|^\\/$|^\\/admin\\/cost-center$|^\\/signal\\/person\\/commits\\/(\\w+)?$|^\\/signal\\/team\\/innovation-rate\\/(\\w+)?$|^\\/signal\\/team\\/scheduled-rate\\/(\\w+)?$|^\\/signal\\/team\\/issues-closed\\/(\\w+)?$|^\\/signal\\/team\\/sprint-volatility\\/(\\w+)?$|^\\/data\\/team\\/issues-open\\/(\\w+)?$|^\\/data\\/person\\/issues-worked\\/(\\w+)?$|^\\/welcome$|^\\/signal\\/person\\/cycle-time\\/(\\w+)?$|^\\/performance\\/people\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/team\\/cycle-time\\/(\\w+)?$|^\\/signal\\/team\\/defects-density\\/(\\w+)?$|^\\/signal\\/team\\/delivered-vs-committed\\/(\\w+)?$|^\\/performance\\/team\\/(\\w+)?$|^\\/data\\/team\\/cost\\/(\\w+)?$|^\\/languages$|^\\/signal\\/person\\/rework-rate\\/(\\w+)?$|^\\/signal\\/team\\/backlog-change\\/(\\w+)?$|^\\/data\\/team\\/sprints-completed\\/(\\w+)?$|^$|^\\/signal\\/person\\/code-ownership\\/(\\w+)?$|^\\/work-forecast\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?\\/(\\w+)?$|^\\/signal\\/team\\/cycle-time\\/data\\/(\\w+)?$|^\\/signal\\/team\\/defects-rate\\/(\\w+)?$|^\\/data\\/team\\/issues-completed\\/(\\w+)?$|^\\/data\\/person\\/traceability\\/(\\w+)?$|^\\/admin$|^\\/jira\\/(\\w+)?$|^\\/signal\\/person\\/changes-per-commit\\/(\\w+)?$|^\\/signal\\/person\\/issues-worked\\/(\\w+)?$|^\\/admin\\/mapping$|^\\/performance-detail\\/team\\/(\\w+)?$|^\\/signal\\/team\\/rework-rate\\/(\\w+)?$|^\\/error$|^\\/performance-detail\\/people\\/(\\w+)?$|^\\/signal\\/person\\/traceability\\/(\\w+)?$)")
	routes = []*Route{
		&Route{
			Name:           "AdminActivate",
			Path:	        "/admin/activate",
