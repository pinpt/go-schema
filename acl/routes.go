...
func init() {
	...
	routes = []*Route{
		...
		&Route{
			Name:           "DataCodeScans",
			Path:	        "/data/code-scans",
			Title:          "Data - Code Scans",
			Public:         false,
			Hidden:         false,
			Admin:          false,
			Description:    "",
		...
		&Route{
			...
			Hidden:         false,
			Admin:          false,
			Description:    "View period changes in performance and other signals",
		...
		&Route{
			Name:           "TeamCodeHealth",
			Path:	        "/signal/code-health/team/:id",
			Title:          "Teams - Code Health",
			Public:         false,
			Hidden:         false,
			Admin:          false,
			Description:    "",
