...
func DBCreateAppTable(ctx context.Context, db *sql.DB) error {
	q := "CREATE TABLE `app` (`id`VARCHAR(64) NOT NULL PRIMARY KEY,`checksum`CHAR(64),`name` VARCHAR(255) NOT NULL,`description`TEXT,`active` TINYINT(1) NOT NULL,`repo_ids`JSON,`created_at` BIGINT(20) UNSIGNED NOT NULL,`updated_at` BIGINT(20) UNSIGNED,`customer_id`VARCHAR(64) NOT NULL,INDEX app_name_index (`name`),INDEX app_customer_id_index (`customer_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;"
