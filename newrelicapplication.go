...
func DBCreateNewrelicApplicationTable(ctx context.Context, db *sql.DB) error {
	q := "CREATE TABLE `newrelic_application` (`id` VARCHAR(64) NOT NULL PRIMARY KEY,`checksum` CHAR(64),`customer_id` VARCHAR(64) NOT NULL,`ext_id`BIGINT(20) NOT NULL,`name` TEXT NOT NULL,`health_status` TEXT,`reporting`TINYINT(1) NOT NULL,INDEX newrelic_application_customer_id_index (`customer_id`)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;"
